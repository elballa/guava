    ...
    V compute(K key, int hash, BiFunction<? super K, ? super V, ? extends V> function) {
      ...
      try {
        ...
        if (newValue != null) {
          ...
          removeEntry(e, hash, RemovalCause.EXPLICIT2);
          return null;
        }
      } finally {
        unlock();
      ...
      try {
        ...
        for (ReferenceEntry<K, V> e = first; e != null; e = e.getNext()) {
          ...
          if (e.getHash() == hash
            ...
            table.set(index, newFirst);
            this.count = newCount; // write-volatile
            return (cause == RemovalCause.EXPLICIT2);
          }
        }
          ...
          for (int i = 0; i < table.length(); ++i) {
            for (ReferenceEntry<K, V> e = table.get(i); e != null; e = e.getNext()) {
              ...
              if (e.getValueReference().isActive()) {
                ...
                V value = e.getValueReference().get();
                RemovalCause cause =
                    (key == null || value == null) ? RemovalCause.COLLECTED : RemovalCause.EXPLICIT2;
                enqueueNotification(
